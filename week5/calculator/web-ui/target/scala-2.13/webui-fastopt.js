...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  ...
  return $as_sci_Map(new $c_sc_MapOps$WithFilter().init___sc_MapOps__F1(namedExpressions, p).map__F1__sc_IterableOps(new $c_sjsr_AnonFunction1().init___sjs_js_Function1((function(this$2, namedExpressions$1) {
    return (function(x$1$2) {
      var x$1 = $as_T2(x$1$2);
      if ((x$1 !== null)) {
        var x = $as_T(x$1.$$und1$f);
        var y = $as_Lcalculator_Signal(x$1.$$und2$f);
        $m_Lcalculator_Signal$();
        var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this$1, y$2, namedExpressions$1$1) {
          return (function() {
            return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(y$2.apply__O()), namedExpressions$1$1)
          })
        })(this$2, y, namedExpressions$1));
        var y$1 = new $c_Lcalculator_Signal().init___F0(expr);
        return new $c_T2().init___O__O(x, y$1)
      } else {
        throw new $c_s_MatchError().init___O(x$1)
      }
    })
...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    ...
    if ($is_Lcalculator_Literal(x1)) {
      ...
      var name = x3.name$2;
      if (references.contains__O__Z(name)) {
        var x1$2 = $as_Lcalculator_Expr($as_Lcalculator_Signal(references.apply__O__O(name)).apply__O());
        if ($is_Lcalculator_Literal(x1$2)) {
          expr = $as_Lcalculator_Expr($as_Lcalculator_Signal(references.apply__O__O(name)).apply__O());
          continue _eval
        } else if ($is_Lcalculator_Ref(x1$2)) {
          return (NaN)
        } else {
          throw new $c_s_MatchError().init___O(x1$2)
        }
...
$c_Lcalculator_TweetLength$.prototype.tweetRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(tweetText) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, tweetText$1) {
    return (function() {
      var thiz = $as_T(tweetText$1.apply__O());
      return ((140 - $uI(thiz.length)) | 0)
    })
  })(this, tweetText));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function($this, remainingCharsCount$1) {
    return (function() {
      return (($uI(remainingCharsCount$1.apply__O()) >= 15) ? "green" : ((($uI(remainingCharsCount$1.apply__O()) <= 14) && ($uI(remainingCharsCount$1.apply__O()) >= 0)) ? "orange" : "red"))
    })
